...
fn build_posts() -> Vec<Post> {
    ...
    vec![
        post("1", PostType::Adoption, AnimalType::Dog, "Mel", "Vira-lata Caramelo", "2 anos", "Mel í© dí³cil, vacinada, castrada e busca um lar cheio de amor.", "Sío Paulo, SP", "Vila Mariana", authors[0].clone(), 127, 23, 45, false, "2h atrás", "(11) 99999-0001", &["vacinada", "castrada", "dí³cil"], -23.5898, -46.6348),
        post("2", PostType::Emergency, AnimalType::Cat, "Sem nome", "Gatinho tigrado", "Estimado 3 meses", "Gatinho encontrado ferido na Av. Paulista. Precisa de atendimento veterinário urgente.", "Sío Paulo, SP", "Bela Vista", authors[1].clone(), 340, 67, 210, true, "45min atrás", "(11) 98888-0002", &["emergência", "ferido"], -23.5614, -46.6559),
